...
vim.keymap.set('n', '<leader>e', vim.diagnostic.open_float, { desc = 'Open floating diagnostics window' })
...
vim.cmd 'autocmd VimEnter * highlight Search NONE'
